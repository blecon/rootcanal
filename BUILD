...
cc_binary(
    ...
    srcs = [
        ...
        "model/setup/phy_message_bus.cc",
        "model/setup/phy_message_bus.h",
        "model/setup/shared_thread_pool.cc",
        "model/setup/shared_thread_pool.h",
        ...
        "model/setup/thread_pool_async_manager.cc",
        "model/setup/thread_pool_async_manager.h",
